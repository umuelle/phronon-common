...
<ul>
  ...
  <li><strong>What you yourself would have done, in sessions with the optional second round</strong> — after you have read the shared update and your own recollection, and before your group talks again, you are asked privately whether you would stay with the van or try to reach help. <strong>Required in those sessions</strong>, stored with your response, shown to your educator only as counts per group — never next to your name — deleted with the class, and <strong>not</strong> part of the research data.</li>
